...
public class PartyUpdatedResponse
{
	 ...
	 */
	public static class PlayerAdded //TODO: maxhp undefined
	{
		...
		public String toString()
		{
			...
			party
					.forEach(p -> builder
							...
							.append(p.properties().life().current()).append(",").append(p.properties().life().max()).append(";")
	 ...
	 */
	public static class Reorder //TODO: impl with listener
	{
		private final Set<GamePlayer> party;
