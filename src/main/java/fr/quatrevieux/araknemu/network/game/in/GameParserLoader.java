...
public final class GameParserLoader implements ParserLoader {
    ...
    public Collection<SinglePacketParser<?>> load() {
        return Arrays.asList(new LoginToken.Parser(), new AskCharacterList.Parser(), new AskRegionalVersion.Parser(), new AddCharacterRequest.Parser(), new ChoosePlayingCharacter.Parser(), new ClientUid.Parser(), new ScreenInfo.Parser(), new AskGift.Parser(), new CreateGameRequest.Parser(), new AskExtraInfo.Parser(), new GameActionRequest.Parser(), new GameActionAcknowledge.Parser(), new GameActionCancel.Parser(), new AskDate.Parser(), new UseSmiley.Parser(), new Ping.Parser(), new Message.Parser(), new DeleteCharacterRequest.Parser(), new SubscribeChannels.Parser(), new AskRandomName.Parser(), new AdminCommand.Parser(), new ObjectMoveRequest.Parser(), new AskBoost.Parser(), new ObjectDeleteRequest.Parser(), new ObjectUseRequest.Parser(), new SpellMove.Parser(),
                new SpellUpgrade.Parser(), new SpellDowngradeRequest.Parser(), new FighterChangePlace.Parser(), new FighterReady.Parser(), new TurnEnd.Parser(), new QuickPing.Parser(), new ListFightsRequest.Parser(), new AskFightDetails.Parser(), new KickOrLeaveRequestParser(), new SetOrientationRequest.Parser(), new CreateDialogRequest.Parser(), new LeaveDialogRequest.Parser(), new ChosenResponse.Parser(), new ExchangeRequest.Parser(), new LeaveExchangeRequest.Parser(), new AcceptExchangeRequest.Parser(), new KamasMovement.Parser(), new ItemsMovement.Parser(), new ExchangeReady.Parser(), new BuyRequest.Parser(), new SellRequest.Parser(), new AdminMove.Parser(), new BlockSpectatorRequest.Parser(), new LockTeamRequest.Parser(), new NeedHelpRequest.Parser(), new ShowCellRequest.Parser(), new InviteRequest.Parser(), new InviteRefuseRequest.Parser(), new InviteAcceptRequest.Parser(), new PartyLeaveRequest.Parser(), new PartyPositionsRequest.Parser(), new PartyFollowRequest.Parser(), new PartyFollowAllRequest.Parser(), new AskRestat.Parser());
    }
}
