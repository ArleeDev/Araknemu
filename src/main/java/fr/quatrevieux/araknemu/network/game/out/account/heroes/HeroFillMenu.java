...
/**
 * List all account characters {@link HandleHeroFillMenu}
 */
public final class HeroFillMenu {
    private final GameSession session;
    private final Collection<AccountCharacter> characters;

    public HeroFillMenu(GameSession session, Collection<AccountCharacter> characters) {
